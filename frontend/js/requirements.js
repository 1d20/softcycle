(function(window) {
    ...
    var Event = function() {
        ...
        this.attach = function(evtName, element, listener, capture) {
            ...
            return handler.apply(element, [evt,
                function(ev) {
                    var e = ev || event,
    ...
    var Level = function(evt, rows, cols, matches) {
        ...
        var cardsList = '!"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVW[\\]^_`abcdefghijklmnopqrstuvwxyzÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ',
            playfieldWrapper = document.getElementById('game'),
            ...
            Card = function(text, pair) {
                ...
                this.draw = function(idx, container) {
                    ...
                    front.className = 'front face ra icon';
    ...
    var MemoryGame = function(evt) {
        ...
        var lvlNum = 2,
            ...
            start = function() {
                ...
                console.log('Click the cards to reveal <strong>' + lvl.matches + '</strong> matches');
            };
